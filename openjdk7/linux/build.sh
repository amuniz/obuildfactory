...
echo "Calculated MILESTONE=$OBF_MILESTONE, BUILD_NUMBER=$OBF_JDK_BUILD_NUMBER, BUILD_DATE=$OBF_BUILD_DATE"
echo "Calculated final version JRE_RELEASE_VERSION=$JRE_RELEASE_VERSION"
